...
array( "name" => "Favicon",
	...
	"placeholder" => esc_attr__( 'Upload or add your favicon URL here (32x32px). Leave blank to display default image.', 'wise-blog' ),
	"type" => "upload",
	"def" => ""),
	
array( "name" => "Preloader URL",
	"id" => $shortname."_preload",
	"placeholder" => esc_attr__( 'Upload or add preloader URL here (.gif, .png or .jpeg). Maximum of 372x152 pixels.', 'wise-blog' ),
	"type" => "upload",
	"def" => ""),
	
array( "name" => "Predefined Preloader",
	"id" => $shortname."_pre_preload",
	"placeholder" => esc_attr__( 'Select preloader (Leave blank for defaults)', 'wise-blog' ),
	"type" => "select",
	"options" => $wise_prel,
	"def" => ""),
	
array( "name" => "Predefined Preloader Color",
...
array( "name" => "Background URL",
	...
	"placeholder" => esc_attr__( 'Upload or add background URL here (1460x876px). Leave blank to display default image.', 'wise-blog' ),
	"type" => "upload",
	"def" => ""),
	
array( "name" => "Disable Site Image Background",
	"id" => $shortname."_disable_back",
	"placeholder" => esc_attr__( 'Turn on to disable site image background.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
...
array( "name" => "Disable Sticky Sidebar",
	...
	"placeholder" => esc_attr__( 'Turn on to disable sticky sidebar.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
...
array( "name" => "Predefined Colors",
	...
	"type" => "select",
	"options" => array("", "newsred", "orange", "darkcyan", "steelblue", "olive", "wallnut", "sienna", "hotpink", "neonpurple"),
	"def" => ""),
...
array( "name" => "Header Tag Lines Title",
	...
	"placeholder" => esc_attr__( 'Add your header tag lines title.', 'wise-blog' ),
	"type" => "text",
	"def" => ""),
	
array( "name" => "Header Tag Lines Span",
	"id" => $shortname."_tag_lines_span",
	"placeholder" => esc_attr__( 'Add your header tag lines span.', 'wise-blog' ),
	"type" => "text",
	"def" => ""),
	
array( "name" => "Header Tag Lines Link",
	"id" => $shortname."_tag_lines_links",
	"placeholder" => esc_attr__( 'Add your header tag lines links.', 'wise-blog' ),
	"type" => "text",
	"def" => ""),
...
array( "name" => "Disable Top Header",
	...
	"placeholder" => esc_attr__( 'Turn on to disable the entire top header.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
	
array( "name" => "Disable Secondary Menu",
	"id" => $shortname."_secondary_menu",
	"placeholder" => esc_attr__( 'Turn on to remove the secondary header from top header.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
	
array( "name" => "Disable Login/Register Links",
	"id" => $shortname."_login",
	"placeholder" => esc_attr__( 'Turn on to remove the login or register links from top header.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),

array( "name" => "Disable Header Date",
	"id" => $shortname."_date_header",
	"placeholder" => esc_attr__( 'Turn on to remove header date from top header.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
	
array( "name" => "Disable Headhesive Menu",
	"id" => $shortname."_headhesive",
	"placeholder" => esc_attr__( 'Turn on to disable headhesive menu.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),

array( "name" => "Header Opacity",
	"id" => $shortname."_head_opacity",
	"placeholder" => esc_attr__( 'Adjust opacity (Leave blank for defaults)', 'wise-blog' ),
	"type" => "select",
	"options" => $wise_opacity,
	"def" => ""),
	
array( "name" => "Headhesive Opacity",
	"id" => $shortname."_headhesive_opacity",
	"placeholder" => esc_attr__( 'Adjust opacity (Leave blank for defaults)', 'wise-blog' ),
	"type" => "select",
	"options" => $wise_opacity,
	"def" => ""),	
...
array( "name" => "Disable Date on Posts",
	...
	"placeholder" => esc_attr__( 'Turn on to disable date on posts.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
	
array( "name" => "Disable Built-in Share Buttons",
	"id" => $shortname."_disable_share_buttons",
	"placeholder" => esc_attr__( 'Turn on to disable built-in share buttons.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
	
array( "name" => "Disable Author Info on Posts",
	"id" => $shortname."_disable_author_posts",
	"placeholder" => esc_attr__( 'Turn on to disable Author Biography for single posts.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
	
array( "name" => "Affiliates Auto Disclaimer",
	"id" => $shortname."_aff_disclaimer",
	"placeholder" => esc_attr__( 'Add your affiliate disclaimer here.', 'wise-blog' ),
	"type" => "textarea",
	"def" => ""),

array( "name" => "Enable Affiliates Disclaimer to Top Posts",
	"id" => $shortname."_enable_aff_top",
	"placeholder" => esc_attr__( 'Turn on to enable affiliates disclaimer to top post. If uncheck it will show at the bottom of post.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
...
array( "name" => "Top Post",
	...
	"placeholder" => esc_attr__( 'Add your Ads code here.', 'wise-blog' ),
	"type" => "textarea",
	"def" => ""),
...
array( "name" => "RSS Link",
	"placeholder" => esc_attr__( 'Add RSS URL.', 'wise-blog' ),
	"id" => $shortname."_soc_rss_links",
	"type" => "text",
	"def" => ""),
	
array( "name" => "Facebook Link",
	"placeholder" => esc_attr__( 'Add Facebook URL.', 'wise-blog' ),
	"id" => $shortname."_soc_fb_links",
	"type" => "text",
	"def" => ""),

array( "name" => "Twitter Link",
	"placeholder" => esc_attr__( 'Add Twitter URL.', 'wise-blog' ),
	"id" => $shortname."_soc_twitter_links",
	"type" => "text",
	"def" => ""),
	
array( "name" => "Twitter Account Name for Share Buttons",
	"placeholder" => esc_attr__( 'Add Twitter Account Name.', 'wise-blog' ),
...
array( "name" => "YouTube Link",
	"placeholder" => esc_attr__( 'Add Youtube URL.', 'wise-blog' ),
...
array( "name" => "Disable Error Details for Login Form",
	...
	"placeholder" => esc_attr__( 'Turn on to disable error details in login form.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),

array( "name" => "Enable Google reCAPTCHA for Login Form",
	"id" => $shortname."_enable_login_reCAPTCHA",
	"placeholder" => esc_attr__( 'Turn on to enable Google reCAPTCHA in login form.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
	
array( "name" => "Enable Google reCAPTCHA for Registration Form",
	"placeholder" => esc_attr__( 'Turn on to enable Google reCAPTCHA in registration form.', 'wise-blog' ),
	"id" => $shortname."_enable_registration_reCAPTCHA",
	"type" => "checkbox",
	"def" => ""),
	
array( "name" => "Enable Google reCAPTCHA for Comment Form",
	"placeholder" => esc_attr__( 'Turn on to enable Google reCAPTCHA in comment form.', 'wise-blog' ),
...
array( "name" => "Google reCAPTCHA Site Key",
	...
	"placeholder" => esc_attr__( 'Add your Google reCAPTCHA site key.', 'wise-blog'),
	"type" => "text",
	"def" => ""),
	
array( "name" => "Google reCAPTCHA Secret Key",
	"id" => $shortname."_captcha_secretkey",
	"placeholder" => esc_attr__( 'Add your Google reCAPTCHA secret key.', 'wise-blog'),
	"type" => "text",
	"def" => ""),
...
array( "name" => "Disable Footer Social Icons",
	...
	"placeholder" => esc_attr__( 'Turn on to disable footer social icons.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
	
array( "name" => "Disable Footer Menu",
	"id" => $shortname."_disable_footermenu",
	"placeholder" => esc_attr__( 'Turn on to disable footer menu.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),

array( "name" => "Disable Footer About Logo",
	"id" => $shortname."_footer_about_logo",
	"placeholder" => esc_attr__( 'Turn on to disable footer logo from about widget.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),

array( "name" => "Disable Footer Logo",
	"id" => $shortname."_footer_logo",
	"placeholder" => esc_attr__( 'Turn on to disable footer logo.', 'wise-blog' ),
	"type" => "checkbox",
	"def" => ""),
...
array( "name" => "Footer Opacity",
	"id" => $shortname."_footer_opacity",
	"placeholder" => esc_attr__( 'Adjust opacity (Leave blank for defaults)', 'wise-blog' ),
	"type" => "select",
	"options" => $wise_opacity,
	"def" => ""),
