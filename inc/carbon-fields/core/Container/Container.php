...
abstract class Container {
	...
	public function get_tabs() {
		...
		if ( ! empty( $untabbed_fields ) ) {
			$this->create_tab( esc_attr__( 'General', 'wise-blog' ), $untabbed_fields, self::TABS_HEAD );
		}
	...
	public function admin_hook_scripts() {
		...
		wp_localize_script( 'carbon-containers', 'carbon_containers_l10n',
			array(
				'please_fill_the_required_fields' => esc_attr__( 'Please fill out all required fields highlighted below.', 'wise-blog' ),
				'changes_made_save_alert' => esc_attr__( 'The changes you made will be lost if you navigate away from this page.', 'wise-blog' ),
			)
		);
	}
