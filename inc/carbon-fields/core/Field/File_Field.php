...
class File_Field extends Field {
	...
	public function admin_init() {
		$this->button_label = esc_attr__( 'Select File', 'wise-blog' );
		$this->window_button_label = esc_attr__( 'Select File', 'wise-blog' );
		$this->window_label = esc_attr__( 'Files', 'wise-blog' );
