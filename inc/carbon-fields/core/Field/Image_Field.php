...
class Image_Field extends File_Field {
	...
	public function admin_init() {
		$this->button_label = esc_attr__( 'Select Image', 'wise-blog' );
		$this->window_button_label = esc_attr__( 'Select Image', 'wise-blog' );
		$this->window_label = esc_attr__( 'Images', 'wise-blog' );
