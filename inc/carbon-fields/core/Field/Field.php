...
class Field {
	...
	public function admin_hook_scripts() {
		...
		wp_localize_script( 'carbon-fields', 'crbl10n',
			array(
				'title' => esc_attr__( 'Files', 'wise-blog' ),
				'geocode_zero_results' => esc_attr__( 'The address could not be found. ', 'wise-blog' ),
				'geocode_not_successful' => esc_attr__( 'Geocode was not successful for the following reason: ', 'wise-blog' ),
				'max_num_items_reached' => esc_attr__( 'Maximum number of items reached (%s items)', 'wise-blog' ),
				'max_num_rows_reached' => esc_attr__( 'Maximum number of rows reached (%s rows)', 'wise-blog' ),
				'cannot_create_more_rows' => esc_attr__( 'Cannot create more than %s rows', 'wise-blog' ),
				'enter_name_of_new_sidebar' => esc_attr__( 'Please enter the name of the new sidebar:', 'wise-blog' ),
				'remove_sidebar_confirmation' => esc_attr__( 'Are you sure you wish to remove this sidebar?', 'wise-blog' ),
				'add_sidebar' => esc_attr__( 'Add Widget Column', 'wise-blog' ),
				'complex_no_rows' => esc_attr__( 'There are no %s yet. Click <a href="#">here</a> to add one.', 'wise-blog' ),
				'complex_add_button' => esc_attr__( 'Add %s', 'wise-blog' ),
				'complex_min_num_rows_not_reached' => esc_attr__( 'Minimum number of rows not reached (%d %s)', 'wise-blog' ),
				'message_form_validation_failed' => esc_attr__( 'Please fill out all fields correctly. ', 'wise-blog' ),
				'message_required_field' => esc_attr__( 'This field is required. ', 'wise-blog' ),
				'message_choose_option' => esc_attr__( 'Please choose an option. ', 'wise-blog' ),
			)
		);
	}
